...
public class Flights extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** The flight list */
   private java.util.List<com.flight.status.api.Flight> Flights;
   ...
   */
  public Flights(java.util.List<com.flight.status.api.Flight> Flights) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: Flights = (java.util.List<com.flight.status.api.Flight>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<com.flight.status.api.Flight> getFlights() {
    return Flights;
  }
   ...
   */
  public void setFlights(java.util.List<com.flight.status.api.Flight> value) {
    this.Flights = value;
  }
   ...
   */
  public static com.flight.status.api.Flights.Builder newBuilder() {
    return new com.flight.status.api.Flights.Builder();
  }
   ...
   * @return A new Flights RecordBuilder
   */
  public static com.flight.status.api.Flights.Builder newBuilder(com.flight.status.api.Flights.Builder other) {
    if (other == null) {
      return new com.flight.status.api.Flights.Builder();
    } else {
      return new com.flight.status.api.Flights.Builder(other);
    }
  }
   ...
   * @return A new Flights RecordBuilder
   */
  public static com.flight.status.api.Flights.Builder newBuilder(com.flight.status.api.Flights other) {
    if (other == null) {
      return new com.flight.status.api.Flights.Builder();
    } else {
      return new com.flight.status.api.Flights.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Flights>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.flight.status.api.Flights.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.flight.status.api.Flights other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.Flights)) {
        this.Flights = data().deepCopy(fields()[0].schema(), other.Flights);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flight.status.api.Flights.Builder setFlights(java.util.List<com.flight.status.api.Flight> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flight.status.api.Flights.Builder clearFlights() {
      Flights = null;
    ...
    public Flights build() {
      try {
        ...
        record.Flights = fieldSetFlags()[0] ? this.Flights : (java.util.List<com.flight.status.api.Flight>) defaultValue(fields()[0]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (com.flight.status.api.Flight e0: this.Flights) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<com.flight.status.api.Flight> a0 = this.Flights;
      if (a0 == null) {
        a0 = new SpecificData.Array<com.flight.status.api.Flight>((int)size0, SCHEMA$.getField("Flights").schema());
        this.Flights = a0;
      } else a0.clear();
      SpecificData.Array<com.flight.status.api.Flight> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<com.flight.status.api.Flight>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          com.flight.status.api.Flight e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new com.flight.status.api.Flight();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
