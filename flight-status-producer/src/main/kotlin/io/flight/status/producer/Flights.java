...
public class Flights extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** The flight list */
   private java.util.List<io.flight.status.producer.Flight> Flights;
   ...
   */
  public Flights(java.util.List<io.flight.status.producer.Flight> Flights) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: Flights = (java.util.List<io.flight.status.producer.Flight>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<io.flight.status.producer.Flight> getFlights() {
    return Flights;
  }
   ...
   */
  public void setFlights(java.util.List<io.flight.status.producer.Flight> value) {
    this.Flights = value;
  }
   ...
   */
  public static io.flight.status.producer.Flights.Builder newBuilder() {
    return new io.flight.status.producer.Flights.Builder();
  }
   ...
   * @return A new Flights RecordBuilder
   */
  public static io.flight.status.producer.Flights.Builder newBuilder(io.flight.status.producer.Flights.Builder other) {
    if (other == null) {
      return new io.flight.status.producer.Flights.Builder();
    } else {
      return new io.flight.status.producer.Flights.Builder(other);
    }
  }
   ...
   * @return A new Flights RecordBuilder
   */
  public static io.flight.status.producer.Flights.Builder newBuilder(io.flight.status.producer.Flights other) {
    if (other == null) {
      return new io.flight.status.producer.Flights.Builder();
    } else {
      return new io.flight.status.producer.Flights.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Flights>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.flight.status.producer.Flights.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.flight.status.producer.Flights other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.Flights)) {
        this.Flights = data().deepCopy(fields()[0].schema(), other.Flights);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flight.status.producer.Flights.Builder setFlights(java.util.List<io.flight.status.producer.Flight> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flight.status.producer.Flights.Builder clearFlights() {
      Flights = null;
    ...
    public Flights build() {
      try {
        ...
        record.Flights = fieldSetFlags()[0] ? this.Flights : (java.util.List<io.flight.status.producer.Flight>) defaultValue(fields()[0]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (io.flight.status.producer.Flight e0: this.Flights) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<io.flight.status.producer.Flight> a0 = this.Flights;
      if (a0 == null) {
        a0 = new SpecificData.Array<io.flight.status.producer.Flight>((int)size0, SCHEMA$.getField("Flights").schema());
        this.Flights = a0;
      } else a0.clear();
      SpecificData.Array<io.flight.status.producer.Flight> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<io.flight.status.producer.Flight>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          io.flight.status.producer.Flight e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new io.flight.status.producer.Flight();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
